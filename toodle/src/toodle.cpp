...
/**
 *  Toodle main contract
 @Author : Ray OShow  (raymond@todos.co.kr)
 @Company : Todos
 @Description: 
    It is contents reward system.
    Conetents writer can get rewards depend on ther stuffs.
    And users can get rewards depend on ther activities.
 */
